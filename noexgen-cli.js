...
function createApplication(name, dir, options, done) {
  ...
  // JavaScript
  var app = options.es6
    ? loadTemplate("js/es6app.js")
    : loadTemplate("js/app.js");
  ...
  if (options.es6) {
    copySingleTemplate(
      "js/routes/es6index.js",
      dir + "/routes/private/index.js"
    );
    copySingleTemplate(
      "js/routes/es6index.js",
      dir + "/routes/public/index.js"
    );
    copySingleTemplate(
